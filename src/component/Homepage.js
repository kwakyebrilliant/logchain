...
function Homepage() {
  ...
  <div class="max-w-screen-xl px-4 pt-16 pb-8 mx-auto sm:px-6 lg:px-8 lg:pt-24">
    <div class="text-center">
      ...
      <a
        href="#"
        class="inline-block px-12 py-3 mt-8 text-sm font-medium text-emerald-600 border border-emerald-600 rounded-full hover:bg-emerald-600 hover:text-white focus:outline-none focus:ring active:bg-emerald-600"
      >
        Get Started
      </a>
    </div>
