    ...
    <div>
      ...
      <Navigation />
          ...
          <div className="relative pt-8">
            <img src={images2} alt="images2" className="w-full rounded object-cover h-screen" />
      
            <div className="grid absolute inset-0 pt-40 p-8 grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
